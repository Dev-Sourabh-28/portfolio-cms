    ...
    >
      ...
      <div
        style={{
          ...
          pointerEvents: "none",
          backgroundImage:
            "repeating-linear-gradient(0deg, transparent, transparent 2px, rgba(0,255,159,0.02) 2px, rgba(0,255,159,0.02) 4px)",
        }}
      />
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-start", justifyContent: "space-between", gap: "20px" }}>
          <div style={{ flex: 1 }}>
            <h1
              style={{
                ...
                textShadow:
                  "0 0 20px rgba(0,255,159,0.5), 2px 0 0 rgba(255,0,80,0.4)",
                fontWeight: portfolio.titleStyle?.fontWeight?.replace('font-', '') || 700,
                color: portfolio.titleStyle?.color || "#00ff9f",
              }}
            >
              {portfolio.title}
            </h1>
            ...
            {portfolio.subtitle && (
              <p
                style={{
                  ...
                  marginTop: "8px",
                  color: portfolio.subtitleStyle?.color || "#00ff9f",
                  opacity: 0.8,
            ...
            <p
              style={{
                ...
                maxWidth: "700px",
                lineHeight: 1.8,
                color: portfolio.bioStyle?.color || "#7fff7f",
                    ...
                    <div style={{
                      ...
                      <a
                        ...
                        style={{
                          ...
                          textTransform: "uppercase",
                          cursor: "pointer",
                          borderTop: "1px solid rgba(0,255,159,0.3)",
                        }}
                        onClick={() => setShowResumeDropdown(false)}
                      >
                        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "12px", alignSelf: "flex-start" }}>
        ...
        >
          <div>
            <div style={{ fontSize: "clamp(1.5rem, 5vw, 2.5rem)", fontWeight: 700 }}>
            ...
            >
              <div
                style={{
                  ...
                  height: "2px",
                  background:
                    "linear-gradient(90deg,#00ff9f,#ff0050,transparent)",
                }}
              />
